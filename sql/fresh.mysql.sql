...
INSERT INTO `CONFIGURATION` VALUES ('completeDayHours','8'),('showTurnOver','true'),('localeLanguage','en'),('currency','Euro'),('localeCountry',NULL),('availableTranslations','en,nl'),('mailFrom','noreply@localhost.net'),('mailSmtp','127.0.0.1');
...
CREATE TABLE `PROJECT` (
  ...
  CONSTRAINT `PROJECT_fk1` FOREIGN KEY (`PROJECT_MANAGER`) REFERENCES `USER` (`USER_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
