...
package net.rrm.ehour.service.project.status;
...
public class ProjectAssignmentStatusServiceImpl implements ProjectAssignmentStatusService
{
	...
	/*
	 * (non-Javadoc)
	 * @see net.rrm.ehour.service.project.status.ProjectAssignmentStatusService#getAssignmentStatus(net.rrm.ehour.service.domain.ProjectAssignment, net.rrm.ehour.service.data.DateRange)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see net.rrm.ehour.service.project.status.ProjectAssignmentStatusService#getAssignmentStatus(net.rrm.ehour.service.domain.ProjectAssignment)
	 */
