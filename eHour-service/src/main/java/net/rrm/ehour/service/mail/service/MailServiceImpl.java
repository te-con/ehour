...
import net.rrm.ehour.service.mail.callbacks.AssignmentMsgCallback;
...
public class MailServiceImpl implements MailService
{
	...
	/*
	 * (non-Javadoc)
	 * @see net.rrm.ehour.service.mail.service.MailService#mailTestMessage(net.rrm.ehour.service.config.EhourConfig)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see net.rrm.ehour.service.mail.service.MailService#mailPMFixedAllottedReached(net.rrm.ehour.service.report.reports.ProjectAssignmentAggregate, java.util.Date, net.rrm.ehour.service.user.domain.User)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see net.rrm.ehour.service.mail.service.MailService#mailPMFlexOverrunReached(net.rrm.ehour.service.report.reports.ProjectAssignmentAggregate, java.util.Date, net.rrm.ehour.service.user.domain.User)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see net.rrm.ehour.service.mail.service.MailService#getSentMailForAssignment(java.lang.Integer[])
	 */
