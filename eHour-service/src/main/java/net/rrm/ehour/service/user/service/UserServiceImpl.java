...
package net.rrm.ehour.service.user.service;
...
import net.rrm.ehour.service.exception.NoResultsException;
...
public class UserServiceImpl implements UserService
{
	...
	/*
	 * (non-Javadoc)
	 * @see net.rrm.ehour.service.user.service.UserService#getUserAndCheckDeletability(java.lang.Integer)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see net.rrm.ehour.service.user.service.UserService#getUser(java.lang.String)
	 */
...
//		}
	...
	/*
	 * (non-Javadoc)
	 * @see net.rrm.ehour.service.user.service.UserService#getUsersWithEmailSet()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see net.rrm.ehour.service.user.service.UserService#addAndcheckProjectManagementRoles(java.lang.Integer)
	 */
	@Transactional
	...
	/*
	 * (non-Javadoc)
	 * @see net.rrm.ehour.service.user.service.UserService#getUsers(net.rrm.ehour.service.user.domain.UserRole)
	 */
...
//		userDAO.initializeObject(users);
	...
	/*
	 * (non-Javadoc)
	 * @see net.rrm.ehour.service.user.service.UserService#getUsersByNameMatch(java.lang.String, boolean, net.rrm.ehour.service.user.domain.UserRole)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see net.rrm.ehour.service.user.service.UserService#deleteUser(net.rrm.ehour.service.user.domain.User)
	 */
	@Transactional
	...
	/*
	 * (non-Javadoc)
	 * @see net.rrm.ehour.service.user.service.UserService#deleteDepartment(java.lang.Integer)
	 */
	@Transactional
