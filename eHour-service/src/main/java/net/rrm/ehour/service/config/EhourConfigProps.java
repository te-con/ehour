...
public class EhourConfigProps implements EhourConfig
{
	...
	/*
	 * (non-Javadoc)
	 * @see net.rrm.ehour.service.config.EhourConfig#getSmtpPassword()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see net.rrm.ehour.service.config.EhourConfig#getSmtpUsername()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see net.rrm.ehour.service.config.EhourConfig#getFirstDayOfWeek()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see net.rrm.ehour.service.config.EhourConfig#getAuditType()
	 */
