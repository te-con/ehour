...
import net.rrm.ehour.service.report.reports.ProjectManagerDashboard;
										...
										implements AggregateReportService 
{
	...
	/*
	 * (non-Javadoc)
	 * @see net.rrm.ehour.service.report.service.ReportService#getHoursPerAssignment(java.lang.Integer[])
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see net.rrm.ehour.service.report.service.AggregateReportService#getAggregateReportData(net.rrm.ehour.service.report.criteria.ReportCriteria)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see net.rrm.ehour.service.report.service.AbstractReportServiceImpl#getReportElements(java.util.List, java.util.List, net.rrm.ehour.service.data.DateRange)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see net.rrm.ehour.service.report.service.ReportService#getProjectManagerReport(net.rrm.ehour.service.data.DateRange, java.lang.Integer)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see net.rrm.ehour.service.report.service.AggregateReportService#getProjectManagerDashboard(net.rrm.ehour.service.domain.User)
	 */
