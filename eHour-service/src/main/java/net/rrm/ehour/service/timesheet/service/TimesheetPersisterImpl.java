...
public class TimesheetPersisterImpl implements TimesheetPersister
{
	...
	/*
	 * (non-Javadoc)
	 * @see net.rrm.ehour.service.timesheet.service.TimesheetPersister#validateAndPersist(net.rrm.ehour.service.domain.ProjectAssignment, java.util.List, net.rrm.ehour.service.data.DateRange)
	 */
