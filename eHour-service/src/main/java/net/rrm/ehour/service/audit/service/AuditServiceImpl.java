...
package net.rrm.ehour.service.audit.service;
...
public class AuditServiceImpl implements AuditService
{
	...
	/* (non-Javadoc)
	 * @see net.rrm.ehour.service.audit.service.AuditService#persistAudit(net.rrm.ehour.service.domain.Audit)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see net.rrm.ehour.service.audit.service.AuditService#getAudit(net.rrm.ehour.service.audit.service.dto.AuditReportRequest)
	 */
	@NonAuditable
	...
	/*
	 * (non-Javadoc)
	 * @see net.rrm.ehour.service.audit.service.AuditService#getAuditCount(net.rrm.ehour.service.audit.service.dto.AuditReportRequest)
	 */
	@NonAuditable
