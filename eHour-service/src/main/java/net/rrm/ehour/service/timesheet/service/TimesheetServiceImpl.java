...
public class TimesheetServiceImpl implements TimesheetService
{
	...
	/*
	 * (non-Javadoc)
	 * @see net.rrm.ehour.service.timesheet.service.TimesheetService#persistTimesheetWeek(java.util.Collection, net.rrm.ehour.service.domain.TimesheetComment, net.rrm.ehour.service.data.DateRange)
	 */
	@Transactional
	...
	/*
	 * (non-Javadoc)
	 * @see net.rrm.ehour.service.timesheet.service.TimesheetService#deleteTimesheetEntries(net.rrm.ehour.service.user.domain.User)
	 */
	@Transactional
