...
package net.rrm.ehour.service.config.service;
...
public class ConfigurationServiceImpl implements ConfigurationService
{
	...
	/* (non-Javadoc)
	 * @see net.rrm.ehour.service.config.service.ConfigurationService#getLogo()
	 */
	@NonAuditable
	@Transactional
	...
	/* (non-Javadoc)
	 * @see net.rrm.ehour.service.config.service.ConfigService#getConfiguration()
	 */
	@Transactional
	@NonAuditable
	...
	/* (non-Javadoc)
	 * @see net.rrm.ehour.service.config.service.ConfigService#persistConfiguration(java.util.List)
	 */
	@Transactional
	@Auditable(actionType=AuditActionType.UPDATE)
