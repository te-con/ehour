...
class SysInfoServiceImpl @Autowired()(@Value("${ehour.database}") databaseName: String, @Value("${ehour.database.url}") databaseUrl: String, @Value("${ehour.database.driver}") jdbcDriver: String) extends SysInfoService {
