...
import net.rrm.ehour.domain.{MailLogAssignment, User}
...
@NonAuditable
@Service ("mailService")
class ProjectManagerNotifierServiceMailImpl @Autowired() (mailMan: MailMan, mailLogAssignmentDao: MailLogAssignmentDao, config: EhourConfig, mailLogDao: MailLogDao) extends ProjectManagerNotifierService {
