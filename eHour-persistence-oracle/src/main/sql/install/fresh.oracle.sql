...
CREATE TABLE CUSTOMER (
  CUSTOMER_ID NUMBER NOT NULL, -- auto_increment,
...
CREATE TABLE USER_DEPARTMENT (
  DEPARTMENT_ID NUMBER NOT NULL, -- auto_increment,
...
CREATE TABLE MAIL_LOG (
  MAIL_LOG_ID NUMBER NOT NULL, -- auto_increment,
  MAIL_TYPE_ID NUMBER NOT NULL,
  TIMESTAMP timestamp NOT NULL,
  SUCCESS char(1) NOT NULL,
  TO_USER_ID NUMBER default NULL,
...
CREATE TABLE PROJECT (
  PROJECT_ID NUMBER NOT NULL, -- auto_increment,
  ...
  ACTIVE char(1) default 'Y' NOT NULL ,
  PROJECT_MANAGER NUMBER default NULL,
...
CREATE TABLE PROJECT_ASSIGNMENT (
  ASSIGNMENT_ID NUMBER NOT NULL, -- auto_increment,
...
CREATE TABLE MAIL_LOG_ASSIGNMENT (
  ...
  PROJECT_ASSIGNMENT_ID NUMBER NOT NULL,
...
CREATE TABLE TIMESHEET_ENTRY (
  ...
  CONSTRAINT entry_pk PRIMARY KEY(ENTRY_DATE,ASSIGNMENT_ID),
