...
public class TimesheetDaoHibernateImplTest extends AbstractAnnotationDaoTest {
    ...
    public void shouldGetTimesheetEntriesInRangeForAssignment() {
        ...
        List<TimesheetEntry> results = timesheetDAO.getTimesheetEntriesInRange(activity, dateRange);
    ...
    public void shouldGetTimesheetEntriesBefore() {
        ...
        List<TimesheetEntry> res = timesheetDAO.getTimesheetEntriesBefore(activity, new Date(2006 - 1900, Calendar.OCTOBER, 3));
    ...
    public void shouldGetTimesheetEntriesAfter() {
        ...
        List<TimesheetEntry> res = timesheetDAO.getTimesheetEntriesAfter(activity, new Date(2006 - 1900, Calendar.OCTOBER, 4));
    ...
    public void shouldGetLatestTimesheetEntryForAssignment() {
        TimesheetEntry entry = timesheetDAO.getLatestTimesheetEntryForActivity(1);
