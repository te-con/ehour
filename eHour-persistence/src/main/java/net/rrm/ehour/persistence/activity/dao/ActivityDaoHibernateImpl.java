...
public class ActivityDaoHibernateImpl extends AbstractGenericDaoHibernateImpl<Activity, Integer> implements ActivityDao {
	...
	protected final static String CACHEREGION = "query.Activity";
	...
	@Override
	public List<Activity> findActivitiesForUser(Integer userId, DateRange dateRange) {
		...
		results = findByNamedQueryAndNamedParam("Activity.findActivitiessForUserInRange", keys, params, true, CACHEREGION);
		
		return results;
	}

	@Override
	public List<Activity> findActivitiesOfProject(Project project, DateRange dateRange) {
		return null;
	}
