...
public class ProjectAssignmentDaoHibernateImpl extends AbstractGenericDaoHibernateImpl<ProjectAssignment, Integer> implements
	...
	public List<ProjectAssignment> findProjectAssignmentsForUser(Integer userId, DateRange range) {
		...
		results = findByNamedQueryAndNamedParam("ProjectAssignment.findProjectAssignmentsForUserInRange", keys, params, true, CACHEREGION);
	...
	public List<ProjectAssignment> findProjectAssignmentForUser(Integer projectId, Integer userId) {
		...
		results = findByNamedQueryAndNamedParam("ProjectAssignment.findProjectAssignmentsForUserForProject", keys, params, true,
				CACHEREGION);
	...
	public List<ProjectAssignment> findProjectAssignmentsForUser(User user) {
		...
		results = findByNamedQueryAndNamedParam("ProjectAssignment.findProjectAssignmentsForUser", "user", user, true, CACHEREGION);
	...
	public List<ProjectAssignment> findProjectAssignmentForUser(Integer projectId, Integer userId, Integer assignmentType) {
		...
		results = findByNamedQueryAndNamedParam("ProjectAssignment.findProjectsForUserForType", names, values, true, CACHEREGION);
	 ...
	 * 
	 * @see
	 * net.rrm.ehour.persistence.persistence.project.dao.ProjectAssignmentDAO
	 * #findProjectAssignmentsForProject
	 * (net.rrm.ehour.persistence.persistence.project.domain.Project,
	...
	public List<ProjectAssignment> findProjectAssignmentsForProject(Project project, DateRange range) {
		...
		results = findByNamedQueryAndNamedParam("ProjectAssignment.findProjectAssignmentsForProjectInRange", keys, params, true,
				CACHEREGION);
	 ...
	 * @see
	 * net.rrm.ehour.persistence.persistence.project.dao.ProjectAssignmentDAO
	 * #findProjectAssignmentsForCustomer
	 * (net.rrm.ehour.persistence.persistence.customer.domain.Customer,
	 * net.rrm.ehour.persistence.persistence.data.DateRange)
	 */
	public List<ProjectAssignment> findProjectAssignmentsForCustomer(Customer customer, DateRange range) {
		...
		results = findByNamedQueryAndNamedParam("ProjectAssignment.findProjectAssignmentsForCustomerInRange", keys, params, true,
				CACHEREGION);
