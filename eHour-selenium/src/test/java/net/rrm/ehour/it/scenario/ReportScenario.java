...
public class ReportScenario extends AbstractScenario {
    ...
    public void should_show_zero_bookings() throws Exception {
        ...
        waitUntil(ExpectedConditions.textToBePresentInElementLocated(WicketBy.wicketPath("reportContainer_panel_reportTable_greyFrame_greyFrame__body_reportContent_reportFrame_reportFrame__body_reportFrameContainer_reportTable_3_cell_6"), "0"));
