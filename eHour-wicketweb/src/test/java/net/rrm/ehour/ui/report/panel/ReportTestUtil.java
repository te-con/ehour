...
public class ReportTestUtil
{
	...
	public static List<AssignmentAggregateReportElement> getAssignmentAggregateReportElements()
	{
        ...
        pagA = AssignmentAggregateReportElementMother.createProjectAssignmentAggregate(1, 1, 1);
        pagA.getProjectAssignment().getProject().setProjectId(1);
        pagB = AssignmentAggregateReportElementMother.createProjectAssignmentAggregate(20, 1, 2);
        pagB.getProjectAssignment().getProject().setProjectId(2);
        pagF = AssignmentAggregateReportElementMother.createProjectAssignmentAggregate(30, 1, 3);
        pagF.getProjectAssignment().getProject().setProjectId(2);
        pagC = AssignmentAggregateReportElementMother.createProjectAssignmentAggregate(3, 2, 1);
        pagD = AssignmentAggregateReportElementMother.createProjectAssignmentAggregate(4, 2, 2);
        pagE = AssignmentAggregateReportElementMother.createProjectAssignmentAggregate(5, 3, 3);
