...
public class CustomerReviewerPanel extends AbstractAjaxPanel<ReportCriteria> {
    ...
    public CustomerReviewerPanel(String id, Calendar overviewFor, List<ApprovalStatus> approvalStatuses) {
        ...
        addAllComponents(overviewFor, approvalStatuses);
    ...
    private void addAllComponents(Calendar overviewFor, List<ApprovalStatus> approvalStatuses) {
        ...
        columns[1] = new PropertyColumn<ApprovalStatus>(new ResourceModel("customerreviewer.timesheet.column.user"), "user.firstName");
        ...
        columns[3] = new AbstractColumn<ApprovalStatus>(new Model<String>("Status")) {
            ...
            private String getStatus(IModel<ApprovalStatus> model) {
                return model.getObject().getStatus().toString();
            }
    ...
    class ViewTimesheetPanel extends Panel {
        public ViewTimesheetPanel(String id, IModel<ApprovalStatus> model) {
            super(id, model);
            final ApprovalStatus approvalStatus = (ApprovalStatus) model.getObject();
