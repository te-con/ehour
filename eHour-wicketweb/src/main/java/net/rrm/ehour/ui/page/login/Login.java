...
public class Login extends WebPage
{
	...
	public final class SignInForm extends Form
	{
		...
		protected void onSubmit()
		{
			  ...
			  System.err.println("# BULL ## ENTERING Login.SignInForm for  Cra Application");
	          HttpServletRequest request = ((org.apache.wicket.protocol.http.servlet.ServletWebRequest) RequestCycle.get().getRequest()) .getHttpServletRequest(); 
              System.err.println("Connected user is= " + request.getRemoteUser());

              String username = request.getRemoteUser();  //user.getUsername();
			...
			} else
			{
				...
				if (session.signIn(username, null))
				{
					Class<? extends WebPage> homepage = getHomepageForRole(session.getRoles());
