...
public class EhourWebSession extends AuthenticatedWebSession
{
	...
	public boolean authenticate(String username, String password)
	{
		...
		//UsernamePasswordAuthenticationToken authRequest = new UsernamePasswordAuthenticationToken(auth.getPrincipal(),auth.getCredentials());
		
		//CasAuthenticationToken authRequest = new CasAuthenticationToken(p, auth, auth, null, null, usedPageMaps, p);
		
		//SecurityContext context = (SecurityContext) this.getAttribute("ACEGI_SECURITY_CONTEXT");
		CasAuthenticationToken authRequest = (CasAuthenticationToken)SecurityContextHolder.getContext().getAuthentication();
