...
public class CustomerReviewerDataProvider extends SortableDataProvider<UserProjectStatus> {
	...
	@Override
	public Iterator<? extends UserProjectStatus> iterator(int first, int count) {
