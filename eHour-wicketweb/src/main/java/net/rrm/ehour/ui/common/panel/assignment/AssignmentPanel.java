...
import net.rrm.ehour.ui.common.panel.assignment.dto.AssignmentAdminBackingBeanImpl;
...
//		tabbedPanel.setVisible(user.getUserId() != null)
	...
	/*
	 * (non-Javadoc)
	 * @see net.rrm.ehour.ui.common.panel.AbstractAjaxAwareAdminPanel#ajaxEventReceived(net.rrm.ehour.ui.common.ajax.AjaxEvent)
	 */
	@Override
