...
public class DepartmentManagePage extends AbstractTabbedManagePage<DepartmentAdminBackingBean> {
    ...
    private static final Logger logger = Logger.getLogger(DepartmentManagePage.class);
    ...
    private Fragment getDepartmentListHolder(List<UserDepartment> departments) {
        Fragment fragment = new Fragment("itemListHolder", "itemListHolder", DepartmentManagePage.this);
