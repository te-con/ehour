...
public class ActivityComparator implements Comparator<Activity>, Serializable
{
    ...
    public final static int ACTIVITY_COMPARE_NAME = 0;
    public final static int ACTIVITY_COMPARE_START = 1;
    public final static int ACTIVITY_COMPARE_CUSTDATEPRJ = 2;

    private int	compareType;

    public ActivityComparator()
    {
        compareType = ACTIVITY_COMPARE_NAME;
    }

    public ActivityComparator(int compareType)
    {
    ...
    public int compare(Activity o1, Activity o2)
    {
        ...
        switch (compareType)
        {
            case ACTIVITY_COMPARE_NAME:
                cmp = compareNames(o1, o2);
                break;
            case ACTIVITY_COMPARE_START:
                cmp = compareDateStart(o1, o2);
                break;
            case ACTIVITY_COMPARE_CUSTDATEPRJ:
     ...
     * @return
     */
    private int compareCustomerStartDateProject(Activity o1, Activity o2)
    {
        int	cmp;
    ...
    private int compareDateStart(Activity o1, Activity o2)
    {
        int cmp;
     ...
     * @return
     */
    private int compareNames(Activity o1, Activity o2)
    {
        if (o1 != null && o2 != null
