...
<div class="ContentFrame">
	<div class="GreyFrame">
		<h3><fmt:message key="report.report.userReport" />: <fmt:formatDate pattern="dd MMM yyyy" value="${userReport.reportCriteria.reportRange.dateStart}" /> - <fmt:formatDate pattern="dd MMM yyyy" value="${userReport.reportCriteria.reportRange.dateEndForDisplay}" />
			&nbsp;&nbsp;<a href="userExcelReport.do">excel</a>
		</h3>
