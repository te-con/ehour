...
Continuous Integration is done with TeamCity at http://dev.ehour.nl/tc/ Please create an account there and check whether the build
is still succesfull after you checked in.
Please junit test all your code, especially additions to the service and the dao layer
